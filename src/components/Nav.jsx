        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              ...
              <Dialog open={isLogOutOpen} handler={() => setIsLogOutOpen(false)}>
                <DialogHeader>Sei sicuro di voler uscire?</DialogHeader>
                <DialogBody>
                  La sessione attuale verrà chiusa e verrai reindirizzato alla home.
                </DialogBody>
                <DialogFooter>
                  <Button variant="text" color="gray" onClick={() => setIsLogOutOpen(false)} className="mr-4">
                    <span>Cancel</span>
                  </Button>
                  <Button
                    variant="gradient"
